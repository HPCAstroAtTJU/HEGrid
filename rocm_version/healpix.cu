...
/***-------------------------------------get_ring_info_small-------------------------------/
/**
 * @brief   Return start index and number of pixels per healpix ring.
 * @param   ring:               The HEALPix ring parameter to get information on.
 * @return  startpix:           The HEALPix index of the first pixel in ring.
 * @return  num_pix_in_ring:    The number of HEALPix pixels in ring.
 * @return  shifted:            Whether the central HEALPix pixel in that ring is shifted from
...
/***------------------------------------pix2ring------------------------------------------*/
/**
 * @brief   Return the ring number that contains the HEALPix pixel.
 * @param   pix:    The pixel of the HEALPix.
 * @return  ring:   The ring of HEALPix
 *---------------------------------------------------------------------------------------*/
...
/***----------------------------------loc2pix----------------------------------------------*/
/**
 * @brief   Convert location (z, phi) to HEALPix Index.
 * @param   z:      z coordinate
 *@param    phi:    phi coordinate
 *@return   pix:    The HEALPiX index
 * -----------------------------------------------------------------------------------------*/
...
/**---------------------------------ang2pix------------------------------------------------*/
/**
 * @brief   Return the pixel index containing the angular coordinates (phi, theta).
 * @param   phi:    phi coordinate(latitude).
 * @param   theta:  theta coordinate(longitude).
 * @return  pix:    The HEALPix pixel index
 * */
...
/**---------------------------------pix2loc-----------------------------------------------*/
/**
 * @brief   Convert HEALPix Pixel Index to location (z, phi).
 * @param   pix:    The HEALPix pixel index.
 * @return  z:      z coordinate (z = cos(vartheta))
 * @return  phi:    phi coordinate
 * */
...
/**-------------------------------------pix2ang---------------------------------------------*/
/**
 * @brief   Convert HEALPix index to angular coordinates(phi, theta)
 * @param   pix:    The HEALPix pixel index.
 * @return  theta:  :math:`\\vartheta` coordinate (:math:`\\vartheta = \\pi/2 - \\mathrm{latitude}`).
 * @return  phi:    :math:`\\varphi` coordinate (longitude).
 * */
